...
import '../../model/resource/color_resource_model.dart';

class ColorResourceData extends ColorResourceModel {
  const ColorResourceData.dark() : super(
  ...
  const ColorResourceData.light() : super(
